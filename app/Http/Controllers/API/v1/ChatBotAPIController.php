...
class ChatBotAPIController extends Controller
{
    ...
    public function getFacebookWebhook (Request $request)
    {
        if (isset($_GET['hub_verify_token'])) {
            if ($_GET['hub_verify_token'] === 'EAASrkWmxF5IBAJ2LKttekATw14uITuYurz0fiioflZBF0abZA67ITmieKXS4KP0V4YSFfpZAfGbl4LWN7Eao1Ih3lxORr8t82FjYM8SjuAcl6PbiWBa03RB8TRA4I448z08coqtweCkRSstPPqROmgiQZBZAgZADAEi2IC6ZB0UugZDZD') {
